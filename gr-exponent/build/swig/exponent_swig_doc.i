...
%feature("docstring") gr::exponent::power_ff "<+description of block+>"

%feature("docstring") gr::exponent::power_ff::make "Return a shared_ptr to a new instance of exponent::power_ff.

To avoid accidental use of raw pointers, exponent::power_ff's constructor is in a private implementation class. exponent::power_ff::make is the public interface for creating new instances.
